...
// Create an [image] DOM element providing the logo 'node'
...
// Set size mode to 'absolute' to set with absolute pixel values: (width 250px, height 250px)
...
var animation = {
    ...
    // Call 'spinLogo', every frame, by passing the 'animation' object back to the 'FamousEngine'
